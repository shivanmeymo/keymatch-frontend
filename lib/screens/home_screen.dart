...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _sendMessage() async {
    ...
    try {
      ...
      final aiResponseText = await KeyMakerService.sendMessage(text);
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  const Text(
                    "I'm your key maker assistant. I can help you find your perfect match by understanding your preferences and suggesting compatible profiles.",
                    style: TextStyle(
                      fontSize: 16,
                      color: Colors.grey,
                      height: 1.5,
                  ...
                  const SizedBox(height: 10),
                  const Text(
                    'Start by telling me what you\'re looking for in a partner!',
                    style: TextStyle(
                      fontSize: 16,
                      color: Colors.grey,
                      height: 1.5,
                ...
                Expanded(
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: 'Ask me about finding your match...',
