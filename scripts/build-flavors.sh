...
# Build script for KeyMatch Android app with different flavors
# Supports dual distribution: Play Store and F-Droid

set -e

echo "🔧 Building KeyMatch Android app for dual distribution..."
...
build_flavor() {
    ...
    local apk_name="keymatch-$flavor-$build_type.apk"
...
build_all_flavors() {
    ...
    echo ""
    echo "📁 Build outputs:"
    echo "  - Play Store: builds/playstore/keymatch-playstore-release.apk"
    echo "  - F-Droid: builds/fdroid/keymatch-fdroid-release.apk"
}
